...
int main() {
    const float kDutyMin = 0.05f;      // non-compliant
    const float kDutyMax = 0.95f;      // non-compliant
    const unsigned kPwmMask = 0xffu;   // non-compliant
    const long kTicksPerCycle = 1000l; // non-compliant
