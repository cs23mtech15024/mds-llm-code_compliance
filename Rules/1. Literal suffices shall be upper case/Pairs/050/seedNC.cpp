...
#include <iostream>
int main() {
    const float kAltitudeGain = 0.75f; // non-compliant
    const unsigned kLoopDelay = 20u;   // non-compliant
    const long kMaxFlightTime = 7200l; // non-compliant
