...
// Fix: All unsigned long long literals now use uppercase ‘ULL’.
...
unsigned long long buildPacketId(const PacketFields& f)
{
    ...
    const unsigned long long SUBSYS_SHIFT = 54ULL;  // C
    const unsigned long long CHAN_SHIFT   = 44ULL;  // C
    const unsigned long long SEQ_SHIFT    = 24ULL;  // C

    const unsigned long long SUBSYS_MASK  = (1ULL << 10ULL) - 1ULL; // C
    const unsigned long long CHAN_MASK    = (1ULL << 10ULL) - 1ULL; // C
    const unsigned long long SEQ_MASK     = (1ULL << 20ULL) - 1ULL; // C
