...
// Rule satisfied: MISRA C++ 2-13-4 – Literal suffixes and exponents shall be upper case.
// Seed: Non-compliant: const double scale = 1.0e-3;   // Compliant: const double scale = 1.0E-3;
// Fix: Replaced lowercase ‘e’ with uppercase ‘E’ in scientific literals.
...
int main() {
    ...
    Sensor s(1.0E-3, 2.5E1);  // C literals
