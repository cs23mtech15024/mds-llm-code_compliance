...
// Violation: Lowercase literal suffixes 'f', 'u', 'l' used.

#include <iostream>
int main() {
    const float kPgain = 0.8f;       // non-compliant
    const unsigned kMaxUpdates = 100u; // non-compliant
    const long kBaseTime = 10000l;   // non-compliant
