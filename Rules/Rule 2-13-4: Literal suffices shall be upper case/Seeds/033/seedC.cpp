...
int main() {
    const float kScanInterval = 1.25F;   // compliant
    const unsigned kMaxOpenFiles = 16U;  // compliant
    const unsigned kPermMask = 0X7FFU;   // compliant
    const long kLogReserve = 8L;         // compliant
