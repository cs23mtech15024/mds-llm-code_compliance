...
// Compliant: each header char declared on its own line (single declarator per declaration)
void header_inspect_C(const std::string &logpath = "hdr_c.log") {
    char c1 = 'A';
    char c2 = 'B';
    ...
    ss << std::boolalpha;
    ss << "[C] header '" << c1 << "' count=" << count1 << " | header '" << c2 << "' count=" << count2
       << " | len=" << len << '\n';
